  ...
  const courseData = [
    {
      ...
      tags: ["mern", "javascript", "backend", "frontend"],
      thumbnail: "https://i.ibb.co/02H7pS9/mern.jpg",
      description:
        "Learn full-stack web development using MongoDB, Express.js, React, and Node.js. Build complete projects from scratch.",
      syllabus: [
...

    {
      ...
      description:
        "Master JavaScript from the basics to advanced concepts like closures, async/await, ES6+, and DOM manipulation.",
      syllabus: [
      ...
      lessons: [
        {
          title: "Understanding Variables & Scope",
...

    {
      ...
      description:
        "Start learning React.js step-by-step. Understand components, hooks, props, context API, and build real-world UI.",
      syllabus: [
        "React Introduction",
        "Components & Props",
        "State & Hooks",
      ...
      lessons: [
        ...
        {
          title: "Using useState & useEffect",
